...
<div class="d-flex">
    <div class="sidebar flex-shrink-0 p-3" style="width: 260px;">
        ...
        <a href="{{ route('admin.orders.index') }}" class="{{ request()->routeIs('admin.orders.*') ? 'active' : '' }}"><i class="fa-solid fa-cart-shopping me-2 w-20"></i> Đơn Hàng</a>
        <a href="{{ route('admin.deliveries.index') }}" class="{{ request()->routeIs('admin.deliveries.*') ? 'active' : '' }}"><i class="fa-solid fa-truck me-2 w-20"></i> Vận Chuyển</a>
        <a href="{{ route('admin.returns.index') }}" class="{{ request()->routeIs('admin.returns.*') ? 'active' : '' }}"><i class="fa-solid fa-rotate-left me-2 w-20"></i> Trả Hàng</a>
        <a href="{{ route('admin.invoices.index') }}" class="{{ request()->routeIs('admin.invoices.*') ? 'active' : '' }}"><i class="fa-solid fa-file-invoice me-2 w-20"></i> Hóa Đơn</a>

        <div class="section-title">Sản Phẩm</div>
        <a href="{{ route('admin.products.index') }}" class="{{ request()->routeIs('admin.products.*') ? 'active' : '' }}"><i class="fa-solid fa-box-open me-2 w-20"></i> Danh Sách SP</a>
        <a href="{{ route('admin.categories.index') }}" class="{{ request()->routeIs('admin.categories.*') ? 'active' : '' }}"><i class="fa-solid fa-layer-group me-2 w-20"></i> Danh Mục</a>
        <a href="{{ route('admin.attributes.index') }}" class="{{ request()->routeIs('admin.attributes.*') ? 'active' : '' }}"><i class="fa-solid fa-tags me-2 w-20"></i> Thuộc Tính</a>
        <a href="{{ route('admin.suppliers.index') }}" class="{{ request()->routeIs('admin.suppliers.*') ? 'active' : '' }}"><i class="fa-solid fa-handshake me-2 w-20"></i> Nhà Cung Cấp</a>
        <a href="{{ route('admin.reviews.index') }}" class="{{ request()->routeIs('admin.reviews.*') ? 'active' : '' }}"><i class="fa-solid fa-star me-2 w-20"></i> Đánh Giá</a>

        <div class="section-title">Kho Hàng</div>
        <a href="{{ route('admin.stocks.index') }}" class="{{ request()->routeIs('admin.stocks.*') ? 'active' : '' }}"><i class="fa-solid fa-cubes me-2 w-20"></i> Tồn Kho</a>
        <a href="{{ route('admin.warehouses.index') }}" class="{{ request()->routeIs('admin.warehouses.*') ? 'active' : '' }}"><i class="fa-solid fa-warehouse me-2 w-20"></i> Danh Sách Kho</a>
        <a href="{{ route('admin.purchase_orders.index') }}" class="{{ request()->routeIs('admin.purchase_orders.*') ? 'active' : '' }}"><i class="fa-solid fa-file-import me-2 w-20"></i> Nhập Hàng (PO)</a>
        ...
        <a href="{{ route('admin.finance.distribution.index') }}" class="{{ request()->routeIs('admin.finance.distribution.*') ? 'active' : '' }}"><i class="fa-solid fa-percent me-2 w-20"></i> Chia Lợi Nhuận</a>
        ...
        <a href="{{ route('admin.promotions.index') }}" class="{{ request()->routeIs('admin.promotions.*') ? 'active' : '' }}"><i class="fa-solid fa-bullhorn me-2 w-20"></i> Chiến Dịch</a>
        <a href="{{ route('admin.coupons.index') }}" class="{{ request()->routeIs('admin.coupons.*') ? 'active' : '' }}"><i class="fa-solid fa-ticket me-2 w-20"></i> Mã Giảm Giá</a>
        <a href="{{ route('admin.flash_sales.index') }}" class="{{ request()->routeIs('admin.flash_sales.*') ? 'active' : '' }}"><i class="fa-solid fa-bolt me-2 w-20"></i> Flash Sale</a>
        <a href="{{ route('admin.affiliate.index') }}" class="{{ request()->routeIs('admin.affiliate.*') ? 'active' : '' }}"><i class="fa-solid fa-network-wired me-2 w-20"></i> Affiliate</a>
        ...
        <a href="{{ route('admin.content.game_subjects.index') }}" class="{{ request()->routeIs('admin.content.game_subjects.*') ? 'active' : '' }}"><i class="fa-solid fa-gamepad me-2 w-20"></i> Game / Học Tập</a>

        <div class="section-title">CRM</div>
        <a href="{{ route('admin.customers.index') }}" class="{{ request()->routeIs('admin.customers.*') ? 'active' : '' }}"><i class="fa-solid fa-user-group me-2 w-20"></i> Khách Hàng</a>
        <a href="{{ route('admin.chat.index') }}" class="{{ request()->routeIs('admin.chat.*') ? 'active' : '' }}"><i class="fa-solid fa-comments me-2 w-20"></i> Hội Thoại</a>

        <div class="section-title">Hệ Thống</div>
        <a href="{{ route('admin.settings.index') }}" class="{{ request()->routeIs('admin.settings.*') ? 'active' : '' }}"><i class="fa-solid fa-gear me-2 w-20"></i> Cài Đặt</a>
        <a href="{{ route('admin.users.index') }}" class="{{ request()->routeIs('admin.users.*') ? 'active' : '' }}"><i class="fa-solid fa-user-shield me-2 w-20"></i> Quản Trị Viên</a>
        <a href="{{ route('admin.roles.index') }}" class="{{ request()->routeIs('admin.roles.*') ? 'active' : '' }}"><i class="fa-solid fa-user-lock me-2 w-20"></i> Phân Quyền</a>
        <a href="{{ route('admin.locations.index') }}" class="{{ request()->routeIs('admin.locations.*') ? 'active' : '' }}"><i class="fa-solid fa-map-location-dot me-2 w-20"></i> Vị Trí</a>
