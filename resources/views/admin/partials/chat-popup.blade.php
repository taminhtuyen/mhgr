    ...
    <div class="chat-layout h-100 d-flex overflow-hidden">
        ...
        <div class="chat-sidebar d-flex flex-column border-end h-100" id="chat-list-col" style="border-color: var(--popup-border) !important;">
            ...
            <div class="p-3 border-bottom flex-shrink-0" style="border-color: var(--popup-border) !important;">
                ...
                {{-- TABS: NGƯỜI MUA -> NGƯỜI BÁN -> HỆ THỐNG --}}
                <ul class="nav nav-tabs nav-tabs-custom" id="chatTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="buyer-tab" data-bs-toggle="tab" data-bs-target="#buyer-pane" type="button" role="tab">Người mua</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="seller-tab" data-bs-toggle="tab" data-bs-target="#seller-pane" type="button" role="tab">Người bán</button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="chat-list flex-grow-1 overflow-auto custom-scrollbar" style="position: relative;">
                ...
                <div class="tab-content" id="chatTabContent">
                        ...
                        <div class="chat-item p-3 d-flex align-items-center cursor-pointer position-relative {{ $i == 1 ? 'active' : '' }}" onclick="openChat('buyer_{{ $i }}')">
                            ...
                            <div class="flex-grow-1 overflow-hidden pe-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0 text-truncate" style="color: var(--text-color); font-size: 0.9rem; font-weight: 600;">Khách Mua {{ $i }}</h6>
                    ...
                    {{-- TAB 2: NGƯỜI BÁN (Đã cập nhật: "Nhà Bán" -> "Người bán") --}}
                    <div class="tab-pane fade" id="seller-pane" role="tabpanel">
                        ...
                        <div class="chat-item p-3 d-flex align-items-center cursor-pointer position-relative" onclick="openChat('seller_{{ $k }}')">
                            ...
                            <div class="flex-grow-1 overflow-hidden pe-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    {{-- Đã thay đổi "Nhà Bán" thành "Người bán" --}}
                    ...
                    <div class="tab-pane fade" id="system-pane" role="tabpanel">
                        ...
                        <div class="chat-item p-3 d-flex align-items-center cursor-pointer position-relative"
                            ...
                            <div class="flex-grow-1 overflow-hidden pe-4">
                                ...
                                <p class="mb-0 text-truncate small mt-1" style="color: var(--text-muted);">Thông báo bảo trì định kỳ...</p>
                            </div>
                        </div>
                        ...
                        <div class="chat-item p-3 d-flex align-items-center cursor-pointer position-relative" onclick="openChat('staff_{{ $s }}')">
                            ...
                            <div class="flex-grow-1 overflow-hidden pe-4">
                                ...
                                <p class="mb-0 text-truncate small mt-1" style="color: var(--text-muted);">Đã gửi báo cáo ngày...</p>
                            </div>
        ...
        <div class="chat-window flex-grow-1 d-flex flex-column h-100" id="chat-content-col">
            ...
            <div class="chat-header p-3 border-bottom d-flex align-items-center flex-shrink-0"
                ...
                <div>
                    <div class="fw-bold lh-1" style="color: var(--text-color); font-size: 0.95rem;">Khách Mua 1</div>
                ...
                <div class="message-row d-flex mb-3">
                    ...
                    <div class="message-wrapper" style="max-width: 75%;">
                        <div class="message-bubble p-2 px-3 rounded shadow-sm"
                            ...
                            Xin chào shop, đơn hàng #{{ $j }}992 bao giờ thì giao ạ?
                        </div>
                ...
                <div class="message-row d-flex mb-3 flex-row-reverse">
                    <div class="message-wrapper text-end" style="max-width: 75%;">
                        <div class="message-bubble p-2 px-3 rounded shadow-sm text-start"
                            ...
                            Chào bạn, bên mình đang đóng gói rồi ạ.
                        </div>
