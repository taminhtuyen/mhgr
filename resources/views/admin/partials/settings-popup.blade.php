    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if(viewBtn) {
            viewBtn.addEventListener('click', (e) => {
                e.preventDefault();
                let current = localStorage.getItem('admin_menu_view') || 'list';
        ...
        const savedEnter = localStorage.getItem('admin_chat_enter_to_send') === 'true';
        if(enterSwitch) {
        ...
        if(enterSwitch) {
            enterSwitch.addEventListener('change', (e) => {
                ...
                localStorage.setItem('admin_chat_enter_to_send', isEnabled);
