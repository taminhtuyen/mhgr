...
class GameSubjectModal extends Component
{
    ...
    protected $listeners = ['openGameSubjectModal' => 'openModal', 'deleteGameSubject' => 'delete'];
    ...
    {
        return view('livewire.admin.content.game-subject-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            GameSubject::find($this->itemId)->update($data);
            $message = 'Cập nhật thành công!';
        } else {
            GameSubject::create($data);
