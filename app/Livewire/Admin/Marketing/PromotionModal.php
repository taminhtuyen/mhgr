...
class PromotionModal extends Component
{
    ...
    protected $listeners = ['openPromotionModal' => 'openModal', 'deletePromotion' => 'delete'];
    ...
    {
        return view('livewire.admin.marketing.promotion-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            Promotion::find($this->itemId)->update($data);
