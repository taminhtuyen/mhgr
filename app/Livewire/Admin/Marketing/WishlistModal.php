...
class WishlistModal extends Component
{
    ...
    protected $listeners = ['openWishlistModal' => 'openModal', 'deleteWishlist' => 'delete'];
    ...
    {
        return view('livewire.admin.marketing.wishlist-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            Wishlist::find($this->itemId)->update($data);
