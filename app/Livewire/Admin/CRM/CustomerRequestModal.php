...
class CustomerRequestModal extends Component
{
    ...
    protected $listeners = ['openCustomerRequestModal' => 'openModal', 'deleteCustomerRequest' => 'delete'];
    ...
    {
        return view('livewire.admin.c-r-m.customer-request-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            CustomerRequest::find($this->itemId)->update($data);
