...
class CustomerModal extends Component
{
    ...
    protected $listeners = ['openCustomerModal' => 'openModal', 'deleteCustomer' => 'delete'];
    ...
    {
        return view('livewire.admin.c-r-m.customer-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            Customer::find($this->itemId)->update($data);
