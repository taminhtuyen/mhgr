...
class SystemLogModal extends Component
{
    ...
    protected $listeners = ['openSystemLogModal' => 'openModal', 'deleteSystemLog' => 'delete'];
    ...
    {
        return view('livewire.admin.system.system-log-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            SystemLog::find($this->itemId)->update($data);
