...
class BookingStatusModal extends Component
{
    ...
    protected $listeners = ['openBookingStatusModal' => 'openModal', 'deleteBookingStatus' => 'delete'];
    ...
    {
        return view('livewire.admin.system.booking-status-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            BookingStatus::find($this->itemId)->update($data);
