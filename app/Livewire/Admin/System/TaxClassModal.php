...
class TaxClassModal extends Component
{
    ...
    protected $listeners = ['openTaxClassModal' => 'openModal', 'deleteTaxClass' => 'delete'];
    ...
    {
        return view('livewire.admin.system.tax-class-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            TaxClass::find($this->itemId)->update($data);
