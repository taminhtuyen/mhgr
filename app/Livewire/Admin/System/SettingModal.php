...
class SettingModal extends Component
{
    ...
    protected $listeners = ['openSettingModal' => 'openModal', 'deleteSetting' => 'delete'];
    ...
    {
        return view('livewire.admin.system.setting-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            Setting::find($this->itemId)->update($data);
