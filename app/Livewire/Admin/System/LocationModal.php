...
class LocationModal extends Component
{
    ...
    protected $listeners = ['openLocationModal' => 'openModal', 'deleteLocation' => 'delete'];
    ...
    {
        return view('livewire.admin.system.location-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            Location::find($this->itemId)->update($data);
