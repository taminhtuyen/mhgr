...
class AttributeModal extends Component
{
    ...
    protected $listeners = ['openAttributeModal' => 'openModal', 'deleteAttribute' => 'delete'];
    ...
    {
        return view('livewire.admin.catalog.attribute-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            Attribute::find($this->itemId)->update($data);
