...
class SupplierModal extends Component
{
    ...
    protected $listeners = ['openSupplierModal' => 'openModal', 'deleteSupplier' => 'delete'];
    ...
    {
        return view('livewire.admin.catalog.supplier-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            Supplier::find($this->itemId)->update($data);
