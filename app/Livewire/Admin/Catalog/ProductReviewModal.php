...
class ProductReviewModal extends Component
{
    ...
    protected $listeners = ['openProductReviewModal' => 'openModal', 'deleteProductReview' => 'delete'];
    ...
    {
        return view('livewire.admin.catalog.product-review-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            ProductReview::find($this->itemId)->update($data);
