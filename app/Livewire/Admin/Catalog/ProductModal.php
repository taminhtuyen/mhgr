...
class ProductModal extends Component
{
    ...
    protected $listeners = ['openProductModal' => 'openModal', 'deleteProduct' => 'delete'];
    ...
    {
        return view('livewire.admin.catalog.product-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            Product::find($this->itemId)->update($data);
