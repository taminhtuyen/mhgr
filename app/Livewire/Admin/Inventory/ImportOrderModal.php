...
class ImportOrderModal extends Component
{
    ...
    protected $listeners = ['openImportOrderModal' => 'openModal', 'deleteImportOrder' => 'delete'];
    ...
    {
        return view('livewire.admin.inventory.import-order-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            ImportOrder::find($this->itemId)->update($data);
