...
class TransactionModal extends Component
{
    ...
    protected $listeners = ['openTransactionModal' => 'openModal', 'deleteTransaction' => 'delete'];
    ...
    {
        return view('livewire.admin.inventory.transaction-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            Transaction::find($this->itemId)->update($data);
