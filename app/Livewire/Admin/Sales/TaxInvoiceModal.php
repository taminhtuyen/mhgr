...
class TaxInvoiceModal extends Component
{
    ...
    protected $listeners = ['openTaxInvoiceModal' => 'openModal', 'deleteTaxInvoice' => 'delete'];
    ...
    {
        return view('livewire.admin.sales.tax-invoice-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            TaxInvoice::find($this->itemId)->update($data);
