...
class OrderReturnModal extends Component
{
    ...
    protected $listeners = ['openOrderReturnModal' => 'openModal', 'deleteOrderReturn' => 'delete'];
    ...
    {
        return view('livewire.admin.sales.order-return-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            OrderReturn::find($this->itemId)->update($data);
