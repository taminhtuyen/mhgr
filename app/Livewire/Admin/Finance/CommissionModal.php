...
class CommissionModal extends Component
{
    ...
    protected $listeners = ['openCommissionModal' => 'openModal', 'deleteCommission' => 'delete'];
    ...
    {
        return view('livewire.admin.finance.commission-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            Commission::find($this->itemId)->update($data);
