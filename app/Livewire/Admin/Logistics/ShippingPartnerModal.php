...
class ShippingPartnerModal extends Component
{
    ...
    protected $listeners = ['openShippingPartnerModal' => 'openModal', 'deleteShippingPartner' => 'delete'];
    ...
    {
        return view('livewire.admin.logistics.shipping-partner-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            ShippingPartner::find($this->itemId)->update($data);
            $message = 'Cập nhật thành công!';
        } else {
            ShippingPartner::create($data);
