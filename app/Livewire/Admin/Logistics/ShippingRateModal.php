...
class ShippingRateModal extends Component
{
    ...
    protected $listeners = ['openShippingRateModal' => 'openModal', 'deleteShippingRate' => 'delete'];
    ...
    {
        return view('livewire.admin.logistics.shipping-rate-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            ShippingRate::find($this->itemId)->update($data);
