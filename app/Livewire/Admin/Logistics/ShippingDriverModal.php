...
class ShippingDriverModal extends Component
{
    ...
    protected $listeners = ['openShippingDriverModal' => 'openModal', 'deleteShippingDriver' => 'delete'];
    ...
    {
        return view('livewire.admin.logistics.shipping-driver-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            ShippingDriver::find($this->itemId)->update($data);
            $message = 'Cập nhật thành công!';
        } else {
            ShippingDriver::create($data);
