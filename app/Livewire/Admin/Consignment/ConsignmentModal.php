...
class ConsignmentModal extends Component
{
    ...
    protected $listeners = ['openConsignmentModal' => 'openModal', 'deleteConsignment' => 'delete'];
    ...
    {
        return view('livewire.admin.consignment.consignment-modal');
    }
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            Consignment::find($this->itemId)->update($data);
