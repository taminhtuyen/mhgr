...
class ConsignmentCustomerModal extends Component
{
    ...
    protected $listeners = ['openConsignmentCustomerModal' => 'openModal', 'deleteConsignmentCustomer' => 'delete'];
    ...
    {
        return view('livewire.admin.consignment.consignment-customer-modal');
    }
    ...
    public function openModal($id = null)
    {
        ...
        if ($id) {
            $this->editMode = true;
            $this->itemId = $id;
            $item = ConsignmentCustomer::find($id);
            if($item) {
    ...
    public function save()
    {
        ...
        if ($this->editMode) {
            ConsignmentCustomer::find($this->itemId)->update($data);
            $message = 'Cập nhật thành công!';
        } else {
            ConsignmentCustomer::create($data);
